 ...
 * `tools/loop/tests/agentCheckDelegation.test.ts` pins each delegated step to a real command in that workflow.
 */
export const STEPS = [
  ...
  { name: "test", args: ["test"], where: "local", after: true, job: "verify" },
