...
/** Every hand size the deal actually produces: 4p → 14/13, 3p → 18, 2p → 14. */
...
describe("enumerator property tests", () => {
  ...
  /**
   * 18 is past what 2^n can answer for, and it is the hand a three-player
   * deal produces — so the enumerator's completeness on the widest real hand
   * was never measured at all. This asks the same question of
   * every play up to BOUNDED_LEN cards; longer straights are out of its
   * reach, and stay covered by the exhaustive sizes above.
   */
  test("finds every short play in a genuine 18-card hand", () => {
