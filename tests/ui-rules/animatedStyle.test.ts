// tests/ui-rules/animatedStyle.test.ts — nothing animates a property the compositor
// cannot animate.
//
...
// holding all 13-18 cards of the hand, which is where that costs the most.
//
...
//
// Structural, like tests/ui-rules/reducedMotion.test.ts: the property is about how the
