// tests/ui-rules/tokenRoles.test.ts — React Native renders an invalid or invisible
 ...
 * contrast against bg, bgCard and felt by tests/ui-rules/contrast.test.ts — that is
...
describe("design tokens are used in the role they were designed for", () => {
  ...
  // 3.66 on bgSurface, 2.98 on the felt. tests/ui-rules/contrast.test.ts lists it as
