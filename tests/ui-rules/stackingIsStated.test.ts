// tests/ui-rules/stackingIsStated.test.ts — an opaque sibling that fills its parent must
...
// `tests/ui-rules/blockingOverlays.test.ts`'s question. What is left is the small case:
