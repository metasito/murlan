// tests/ui-rules/reducedMotion.test.ts — nothing animates behind the setting's back.
//
...
// stop.
//
// Structural, like tests/ui-rules/orientation.test.ts: the property is about how the
