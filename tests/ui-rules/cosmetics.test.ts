// tests/ui-rules/cosmetics.test.ts — the player can repaint the table and the card
...
// tests/ui-rules/contrast.test.ts pins every text token against Colors.felt. That check
