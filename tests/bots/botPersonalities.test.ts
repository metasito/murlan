// tests/bots/botPersonalities.test.ts — every personality must stay a legal, finite
// player. The property test in tests/engine/enumerator.property.test.ts already proves
