// tests/tooling/wallClockBudgets.test.ts — a test that times an operation and compares
...
//
// Structural, like tests/ui-rules/a11yProps.test.ts: the property is about how the
