// tests/tooling/soakRejoinOracle.test.ts — what an unanswered rejoin is evidence of.
//
// `tests/tooling/soakAwayWindow.test.ts` keeps the away window a safe multiple under the shortest
