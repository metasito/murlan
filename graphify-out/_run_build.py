...
if __name__ == "__main__":
    ...
    to_json(G, communities, "C:/Users/roton/murlan/graphify-out/graph.json")
    ...
    Path("C:/Users/roton/murlan/graphify-out/.graphify_analysis.json").write_text(json.dumps(analysis, indent=2, ensure_ascii=False), encoding="utf-8")
