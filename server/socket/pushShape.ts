// The pure half of server/socket/push.ts: what goes to Expo, and what comes back.
//
// Split out for the same reason server/game/replayShape.ts is — this half has no
