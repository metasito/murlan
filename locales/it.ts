...
export const it: Record<keyof typeof en, string> = {
  ...
  "settings.screenShake": "Scossa dello schermo",
  "settings.screenShakeSubtitle": "Il tavolo sobbalza nelle giocate forti",
  ...
  "settings.screenShakeA11yLabel": "Scossa dello schermo",
  "settings.screenShakeA11yHint": "Attiva o disattiva la scossa del tavolo",
  ...
  "home.returnToTable": "Torna al tuo tavolo",
  "home.returnToTableSublabel": "Un posto è ancora tuo",
  ...
  "ladder.meLoadingA11yLabel": "Caricamento del tuo punteggio",
  "ladder.meErrorTitle": "Impossibile caricare il tuo punteggio",
  "ladder.meRetryA11yLabel": "Riprova a caricare il tuo punteggio",
  ...
  "result.home": "Home",
  "result.leaveConfirmTitle": "Lasciare la partita?",
  "result.leaveConfirmBody": "La partita è ancora in corso. Tornare alla home la annulla, insieme ai punteggi finora.",
  "result.leaveConfirmConfirm": "Esci",
  ...
  "tutorial.pass": "Passa",
  "tutorial.stagedReady": "Pronta: questa batte il tavolo.",
  "tutorial.stagedBlocked": "Non ancora: {{reason}}",
  "tutorial.beat.pass.title": "Quando non puoi batterla",
  "tutorial.beat.pass.instruction": "Dea gioca il 2♠ e nella tua mano niente lo batte. Premi Passa: il turno va avanti e puoi ancora giocare più tardi in questo giro.",
  "tutorial.beat.pass.tip": "Chi apre un nuovo giro non può passare: aprire vuol dire giocare qualcosa.",
  "tutorial.beat.pass.opponentLabel": "Dea ha giocato: 2♠",
  "tutorial.beat.pass.successNarrative": "Hai passato. Quando tutti gli altri passano di fila, chi ha giocato per ultimo sgombra il tavolo e apre.",
  "tutorial.beat.clock.title": "L'orologio del turno",
  "tutorial.beat.clock.body1": "Quando tocca a te rispondere, un orologio conta alla rovescia sul tavolo. Gli ultimi secondi ticchettano ad alta voce.",
  "tutorial.beat.clock.body2": "Se arriva a zero, il turno viene passato per te. Guardalo scorrere qui sotto.",
  "tutorial.beat.clock.cta": "Capito",
  "tutorial.beat.stage.title": "Preparare una giocata",
  "tutorial.beat.stage.instruction": "Dea gioca una coppia di 7. Prendi le carte per preparare la risposta: prima di confermare, il tavolo ti dice se passa.",
  "tutorial.beat.stage.tip": "Prova prima la coppia di 6, poi i 9.",
  "tutorial.beat.stage.opponentLabel": "Dea ha giocato: 7♠ 7♥",
  "tutorial.beat.stage.successNarrative": "I 9 battono i 7. Preparare la giocata ti permette di controllarla prima che finisca sul tavolo.",
  ...
  "room.copyFailed": "Impossibile copiare il codice della stanza.",
  ...
  "room.botsComingIn": "I bot possono occupare i posti tra {{seconds}}s",
  ...
  "friends.pendingLoadErrorTitle": "Impossibile caricare le richieste in sospeso.",
  "friends.pendingLoadRetryA11yLabel": "Riprova a caricare le richieste in sospeso",
  "friends.actionFailed": "Operazione non riuscita. Riprova.",
