...
export const it = {
  ...
  "gameOverOverlay.winnerSubtitle": "VINCITORE · Online",
  ...
  "gameOverOverlay.rematch": "Rivincita",
  "gameOverOverlay.voteRematchA11yLabel": "Vota per la rivincita",
  "gameOverOverlay.rematchVotes": "{{count}}/{{total}} vogliono giocare",
  ...
  // ------------------------------------------------------------- offlineGame.*
  "offlineGame.roundLabel": "Partita",
  ...
  "lobby.roundsLabel": "MANCHE",
  "lobby.roundSingle": "partita",
  "lobby.roundMultiple": "manche",
  ...
  "result.roundOfTotal": "Manche {{current}} di {{total}}",
  "result.gameOverTitle": "Partita Finita",
  "result.tournamentChampion": "Campione del Torneo",
  "result.wonRound": "Vince Manche {{n}}",
  "result.statPlayers": "Giocatori",
  "result.statRounds": "Manche",
  "result.statMode": "Modalità",
  "result.legend": "+{{a}} / +{{b}} ... +0 per 1° → ultimo",
  "result.home": "Home",
  "result.nextRound": "Prossima Manche",
