...
export const it: Record<keyof typeof en, string> = {
  ...
  "settings.logoutFailedBody": "Non siamo riusciti a raggiungere il server. Non è cambiato nulla: sei ancora collegato e questo dispositivo riceve ancora gli inviti.",
