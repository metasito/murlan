...
export const it: Record<keyof typeof en, string> = {
  ...
  "settings.musicVolumeSubtitle": "Quanto forte suona la musica sotto il gioco",
  ...
  "settings.logoutA11yLabel": "Esci",
  "settings.logoutConfirmTitle": "Vuoi uscire?",
  "settings.logoutConfirmBody": "Per rientrare ti serviranno email e password. Le partite e le statistiche restano sull'account.",
  "settings.logoutFailedTitle": "Sei ancora dentro",
  "settings.logoutFailedBody": "Non siamo riusciti a raggiungere il server, quindi non è cambiato nulla. Riprova tra un momento.",
