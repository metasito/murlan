...
export const it: Record<keyof typeof en, string> = {
  ...
  // -------------------------------------------------------------- cardView.*
  "cardView.jokerColored": "Joker rosso",
  ...
  "lobby.rankJokerColored": "Joker Rosso",
  "lobby.rankJokerBlack": "Joker Nero",
  ...
  "rules.strengthJokerColored": "Joker Rosso",
  "rules.strengthJokerBlack": "Joker Nero",
  ...
  "tutorial.beat.exchange.instruction": "Dopo ogni manche, chi ha vinto e chi ha perso si scambiano una carta. Hai vinto l'ultima manche: chi ha perso ti ha già dato automaticamente la sua carta più forte, il Joker Rosso. Ora scegli tu una carta da restituirgli, di valore compreso tra 3 e 10.",
