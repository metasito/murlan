...
export const en = {
  ...
  "settings.screenShakeSubtitle": "The table jolts on big plays",
  ...
  "settings.screenShakeA11yLabel": "Screen shake",
  "settings.screenShakeA11yHint": "Turn the table shake on or off",
