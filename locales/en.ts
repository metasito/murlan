...
export const en = {
  ...
  "server.DEV_SYNC_NOT_CONFIGURED": "Dev sync hook is not configured",
  "server.INVALID_WEBHOOK_SIGNATURE": "Invalid webhook signature",
  "server.IGNORED_NON_MAIN_PUSH": "Not a main push",
  "server.DEV_SYNC_FAILED": "Dev sync was not applied",
  ...
  "server.PLAYER_AFK_AUTO_EXCHANGE": "{{username}} is inactive — the card was exchanged automatically",
  ...
  "server.SESSION_REVOKED": "You have been signed out on this device. Sign in again to keep playing.",
  ...
  "recover.requestIntro": "Enter your email and, if it has a verified account, we'll send a reset code.",
  "recover.emailLabel": "Email",
  "recover.emailPlaceholder": "you@example.com",
  "recover.emailA11yLabel": "Email",
  "recover.requestSubmit": "Send code",
  "recover.requestSaving": "Sending…",
  ...
  "recover.codeA11yLabel": "Reset code",
  "recover.newPasswordLabel": "New password",
  "recover.newPasswordPlaceholder": "New password",
  "recover.newPasswordA11yLabel": "New password",
  "recover.resetSubmit": "Reset password",
  "recover.resetSaving": "Saving…",
  "recover.missingFields": "Enter the code and a new password",
  "recover.resetFailed": "The password could not be reset. Try again.",
  ...
  "settings.musicSubtitle": "A quiet loop while you play",
  "settings.musicA11yLabel": "Background music",
  "settings.musicA11yHint": "Turn background music on or off",
  "settings.musicVolumeA11yLabel": "Background music volume",
  ...
  "settings.reportBugA11yHint": "Tell us something is wrong with the game",
  "settings.reportBugPrompt": "Say what went wrong. We also send the screen you were on, your app version, platform and language — nothing about the other players.",
  "settings.reportBugPlaceholder": "What happened?",
  "settings.reportBugFieldA11yLabel": "What went wrong",
  "settings.reportBugSend": "Send report",
  "settings.reportBugSending": "Sending…",
  "settings.reportBugSentTitle": "Report sent",
  "settings.reportBugSentBody": "Thank you — this goes straight to the people who can fix it.",
  "settings.reportBugFailedTitle": "Not sent",
  "settings.reportBugFailedBody": "The report could not be sent. Please try again in a moment.",
  "settings.logout": "Log out",
  "settings.logoutA11yLabel": "Log out of this account",
  ...
  "settings.logoutFailedBody": "We could not reach the server, so nothing has changed. Try again in a moment.",
  ...
  "gameShared.startReasonCard": "{{name}} starts — holds the {{rank}}{{suit}}",
  ...
  "gameTable.playA11ySpokenStartCard": "the first play must include the {{card}}",
  "gameTable.playA11ySpokenRoyalUnbeatable": "a royal straight beats everything: you can't answer this",
  "gameTable.playA11ySpokenBombOnly": "only a higher bomb can beat this",
  "gameTable.playA11ySpokenWrongType": "you must answer with the same type of combination, or pass",
  "gameTable.playA11ySpokenNothingSelected": "no cards selected",
  "gameTable.playA11ySpokenYouAreDone": "you have finished this hand",
  "gameTable.playA11ySpokenNotYourTurn": "it is not your turn",
  "gameTable.playA11ySpokenWrongLength": "it must have the same number of cards as the one on the table",
  ...
  "onlineGame.seatReleasedTitle": "Your seat was given up",
  ...
  "history.errorTitle": "Couldn't load your hands",
  ...
  "history.cardTitle": "Recent matches",
  "history.retryA11yLabel": "Retry loading match history",
  "history.emptyTitle": "No matches yet",
  "history.emptyBody": "Your match history will show up here as soon as you play your first hand.",
  "history.players_one": "{{count}} player",
  "history.players_other": "{{count}} players",
  "history.rowA11yLabel": "{{position}} place, {{mode}}, {{players}}, {{points}} points, {{time}}",
  "history.with": "with {{names}}",
  "history.door": "See all {{count}} hands",
  "history.doorA11yLabel": "See all {{n}} of your hands",
  "history.botSeat": "an AI",
  "history.unknownSeat": "a deleted account",
  "history.watchA11yLabel": "Watch: {{summary}}",
  ...
  "ladder.meLoadingA11yLabel": "Loading your rating",
  "ladder.meErrorTitle": "Couldn't load your rating",
  "ladder.meRetryA11yLabel": "Try loading your rating again",
  ...
  "rules.faq.a2": "The first hand at a new table:\nWhoever holds the 3♠ opens the game, and the first play MUST include that card. At 3 and 4 players the entire deck is dealt, so the 3♠ is always in someone's hand. At 2 players it can land among the {{undealt}} undealt cards instead — when that happens, whoever holds the lowest dealt card opens, and the first play must include that card instead.\n\nLater rounds (after the card exchange):\n• Whoever lost the previous round opens the next one.\n• If the winner won without an exchange taking place (the two-Jokers exception), the winner opens the next round themselves.\n\nPlay always proceeds clockwise.",
  ...
  "rules.faq.a8": "In a match with N players, each hand awards points by finishing order:\n• 1st place: N-1 points\n• 2nd place: N-2 points\n• ...\n• Last place: 0 points\n\nExamples:\n▸ 2 players: 1st = 1pt, 2nd = 0pt\n▸ 3 players: 1st = 2pt, 2nd = 1pt, 3rd = 0pt\n▸ 4 players: 1st = 3pt, 2nd = 2pt, 3rd = 1pt, 4th = 0pt\n\nPoints accumulate across rematch hands. The match target scales with the number of players, so a match takes about the same number of hands at every table size:\n▸ 2 players: 7, rising to 10, 14, 17\n▸ 3 players: 14, rising to 21, 27, 34\n▸ 4 players: 21, rising to 31, 41, 51\n\nYou win the match by being the first to reach the target. If more than one player reaches it in the same hand, the target rises to the next one: if the tie still persists at the last one, the match ends in a draw.",
  ...
  "rules.faq.a15": "• 2 players: 14 cards each — 26 stay face down and unused, so hands can't be worked out by elimination\n• 3 players: 18 cards each (the entire deck)\n• 4 players: 14 cards to two players, 13 to the other two (54 doesn't divide evenly by 4, entire deck)\n\nAt 3 and 4 players the 3♠ and both Jokers are always in play. At 2 players they might land in the undealt 26 — if the 3♠ does, whoever holds the lowest card in play opens instead.",
  "rules.faq.q16": "How does the online Rematch work?",
  "rules.faq.a16": "In Online mode, a rematch is democratic:\n\n• Every player sees the \"Rematch\" button on the results screen\n• A new game starts ONLY once EVERY player has clicked Rematch\n• The counter shows in real time how many have already voted (e.g. 2/4 want to play)\n• If not everyone votes, you can always leave by pressing Exit\n\nScores accumulate from one rematch to the next, and the first player (or pair) to reach the match target wins it — see \"How are points calculated?\" for the targets.",
  ...
  "tutorial.beat.exchange.instruction": "After every hand, the winner and the loser exchange a card. You won the last hand: the loser has already automatically given you their strongest card, the Red Joker. Now you choose a card to give back to them, ranked between 3 and 10.",
  ...
  "tutorial.pass": "Pass",
  "tutorial.stagedReady": "Ready: this beats the table.",
  "tutorial.stagedBlocked": "Not yet: {{reason}}",
  "tutorial.beat.pass.title": "When you can't beat it",
  "tutorial.beat.pass.instruction": "Dea plays the 2♠, and nothing in your hand beats it. Press Pass: the turn moves on, and you can still play later in this round.",
  "tutorial.beat.pass.tip": "Whoever leads a new round can't pass — leading means playing something.",
  "tutorial.beat.pass.opponentLabel": "Dea played: 2♠",
  "tutorial.beat.pass.successNarrative": "You passed. When everyone else passes in a row, whoever played last clears the table and leads.",
  "tutorial.beat.clock.title": "The turn clock",
  "tutorial.beat.clock.body1": "When it's your turn to answer, a clock counts down on the table. Its last seconds tick out loud.",
  "tutorial.beat.clock.body2": "If it runs out, your turn is passed for you. Watch it run below.",
  "tutorial.beat.clock.cta": "Got it",
  "tutorial.beat.stage.title": "Staging a play",
  "tutorial.beat.stage.instruction": "Dea plays a pair of 7s. Pick cards up to stage your answer: before you commit, the table tells you whether it will go.",
  "tutorial.beat.stage.tip": "Try the pair of 6s first, then the 9s.",
  "tutorial.beat.stage.opponentLabel": "Dea played: 7♠ 7♥",
  "tutorial.beat.stage.successNarrative": "The 9s beat the 7s. Staging lets you check a play before it's on the table.",
  ...
  "room.copyFailed": "Couldn't copy the room code.",
  ...
  "room.seatHeldFor": "Held for {{username}}",
  "room.waitingForPlayers": "Waiting for players",
  "room.teamsNeedFour": "Teams mode needs 4 players",
  ...
  "friends.loadRetryA11yLabel": "Try loading your friends again",
  "friends.pendingLoadErrorTitle": "Couldn't load your pending requests.",
  "friends.pendingLoadRetryA11yLabel": "Try loading your pending requests again",
  "friends.actionFailed": "That didn't go through. Try again.",
  ...
  "friends.sectionPending": "PENDING",
  "friends.pendingIncoming": "Waiting for you",
  "friends.pendingOutgoing": "Waiting for them",
  "friends.emptyPending": "Nothing pending.\nRequests you receive and requests you send both appear here.",
  "friends.awaitingSince": "Awaiting response · {{time}}",
  ...
  "profile.verifyEmailTitle": "Verify your email",
  "profile.verifyEmailBody": "We sent a code to {{email}}. Verify it to finish enabling password recovery.",
  "profile.verifyEmailEnterCode": "Enter code",
  "profile.verifyEmailResend": "Resend",
  "profile.verifyEmailResendSaving": "Sending…",
  "profile.verifyEmailResendSuccess": "Code resent — check your email.",
  "profile.verifyEmailResendFailed": "The code could not be resent. Try again.",
  ...
  "profile.formTitle": "Form",
  "profile.formSampleNote": "From your last {{n}} matches.",
  "profile.formRecentLabel": "Recent results",
  "profile.formRecentA11yLabel": "Recent results, newest first: {{results}}",
  "profile.formDistributionLabel": "Where you finish",
  "profile.formPlacementRowA11yLabel": "{{position}}: {{n}} of {{total}} matches",
  "profile.formByPlayersLabel": "By table size",
  "profile.formByPlayersRowA11yLabel": "{{players}}: {{played}} played, {{won}} won, average finish {{avg}}",
  "profile.formAveragePlacement": "avg {{n}}",
  ...
  // ----------------------------------------------------------- handBreakdown.*
  "handBreakdown.toggle": "Hand breakdown",
  "handBreakdown.toggleA11yLabel": "Show what this hand did to your record",
  "handBreakdown.hideA11yLabel": "Hide the hand breakdown",
  "handBreakdown.loadingA11yLabel": "Loading the hand breakdown",
  "handBreakdown.errorTitle": "Couldn't load the breakdown",
  "handBreakdown.retry": "Retry",
  "handBreakdown.retryA11yLabel": "Retry loading the hand breakdown",
  "handBreakdown.ratingLabel": "Ranked rating",
  "handBreakdown.ratingChange": "{{delta}} → {{rating}}",
  "handBreakdown.ratingUnranked": "Not a ranked hand",
  "handBreakdown.ratingProvisional": "Provisional — {{n}} more ranked hands",
  "handBreakdown.placementLabel": "Finish",
  "handBreakdown.placementValue": "{{position}} of {{players}} · {{points}}pt",
  "handBreakdown.bombsLabel": "Bombs thrown",
  "handBreakdown.streakLabel": "Win streak",
  "handBreakdown.streakValue": "{{n}} · best {{best}}",
  "handBreakdown.streakNone": "No streak running",
  "handBreakdown.formLabel": "Recent form",
