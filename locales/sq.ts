...
export const sq: Record<keyof typeof it, string> = {
  ...
  "gameOverOverlay.handWinnerSubtitle": "FITON RAUNDIN",
  ...
  "gameOverOverlay.singleHandFormat": "Një raund",
  "gameOverOverlay.nextHand": "Raundi tjetër",
  "gameOverOverlay.nextHandWaiting": "{{count}}/{{total}} gati",
  "gameOverOverlay.nextHandA11yLabel": "Gati për raundin tjetër",
