...
export const sq: Record<keyof typeof en, string> = {
  ...
  "rules.faq.a15": "• 2 lojtarë: 21 letra secili — 12 mbeten të mbuluara dhe të papërdorura, kështu që letrat nuk mund të nxirren me eliminim\n• 3 lojtarë: 18 letra secili (i gjithë mazhi)\n• 4 lojtarë: 14 letra dy lojtarëve, 13 dy të tjerëve (54 nuk ndahet saktësisht me 4, mazhi i plotë)\n\nMe 3 dhe 4 lojtarë, 3♠ dhe të dy Xholat janë gjithmonë në lojë. Me 2 lojtarë ato mund të bien mes 12 letrave të pashpërndara — nëse kjo ndodh me 3♠, fillon kush ka letrën më të ulët në lojë.",
