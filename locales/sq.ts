...
export const sq: Record<keyof typeof en, string> = {
  ...
  "settings.musicVolume": "Volumi i muzikës",
  "settings.musicVolumeSubtitle": "Sa fort dëgjohet muzika nën lojë",
  ...
  "settings.logout": "Dil",
  "settings.logoutA11yLabel": "Dil",
  "settings.logoutConfirmTitle": "Do të dalësh?",
  "settings.logoutConfirmBody": "Për të hyrë sërish të duhen email-i dhe fjalëkalimi. Ndeshjet dhe statistikat mbeten në llogari.",
  "settings.logoutFailedTitle": "Je ende brenda",
  "settings.logoutFailedBody": "Nuk arritëm te serveri, prandaj nuk ndryshoi asgjë. Provo përsëri pas pak.",
