...
export const sq: Record<keyof typeof en, string> = {
  ...
  "recover.requestIntro": "Shkruaj email-in tënd — nëse ka një llogari të verifikuar, do të dërgojmë një kod rivendosjeje.",
  "recover.emailLabel": "Email",
  "recover.emailPlaceholder": "ti@shembull.com",
  "recover.emailA11yLabel": "Email",
  "recover.requestSubmit": "Dërgo kodin",
  "recover.requestSaving": "Duke dërguar…",
  ...
  "recover.codeA11yLabel": "Kodi i rivendosjes",
  "recover.newPasswordLabel": "Fjalëkalimi i ri",
  "recover.newPasswordPlaceholder": "Fjalëkalimi i ri",
  "recover.newPasswordA11yLabel": "Fjalëkalimi i ri",
  "recover.resetSubmit": "Rivendos fjalëkalimin",
  "recover.resetSaving": "Duke ruajtur…",
  "recover.missingFields": "Shkruaj kodin dhe një fjalëkalim të ri",
  "recover.resetFailed": "Fjalëkalimi nuk u rivendos dot. Provo sërish.",
  ...
  "settings.screenShake": "Dridhja e ekranit",
  "settings.screenShakeSubtitle": "Tavolina dridhet në lojërat e mëdha",
  ...
  "settings.screenShakeA11yLabel": "Dridhja e ekranit",
  "settings.screenShakeA11yHint": "Aktivizo ose çaktivizo dridhjen e tavolinës",
  ...
  "replay.loadFailedTitle": "Replay-i nuk u ngarkua",
  "replay.retryA11yLabel": "Provo përsëri të ngarkosh replay-in",
  ...
  "ladder.meLoadingA11yLabel": "Po ngarkohet pikëzimi yt",
  "ladder.meErrorTitle": "Pikëzimi yt nuk u ngarkua",
  "ladder.meRetryA11yLabel": "Provo përsëri të ngarkosh pikëzimin tënd",
  ...
  "tutorial.pass": "Kalo",
  "tutorial.stagedReady": "Gati: kjo e mund tavolinën.",
  "tutorial.stagedBlocked": "Jo ende: {{reason}}",
  "tutorial.beat.pass.title": "Kur nuk mund ta mundësh",
  "tutorial.beat.pass.instruction": "Dea luan 2♠ dhe asgjë në dorën tënde nuk e mund. Shtyp Kalo: radha vazhdon dhe mund të luash sërish më vonë në këtë xhiro.",
  "tutorial.beat.pass.tip": "Kush hap një xhiro të re nuk mund të kalojë: të hapësh do të thotë të luash diçka.",
  "tutorial.beat.pass.opponentLabel": "Dea luajti: 2♠",
  "tutorial.beat.pass.successNarrative": "Kalove. Kur të gjithë të tjerët kalojnë radhazi, kush luajti i fundit pastron tavolinën dhe hap.",
  "tutorial.beat.clock.title": "Ora e radhës",
  "tutorial.beat.clock.body1": "Kur është radha jote të përgjigjesh, një orë numëron mbrapsht në tavolinë. Sekondat e fundit tingëllojnë.",
  "tutorial.beat.clock.body2": "Nëse mbaron, radha kalohet për ty. Shikoje si ecën më poshtë.",
  "tutorial.beat.clock.cta": "E kuptova",
  "tutorial.beat.stage.title": "Përgatitja e një lëvizjeje",
  "tutorial.beat.stage.instruction": "Dea luan një çift 7-she. Ngri letrat për të përgatitur përgjigjen: para se ta konfirmosh, tavolina të thotë nëse kalon.",
  "tutorial.beat.stage.tip": "Provo fillimisht çiftin e 6-ave, pastaj 9-at.",
  "tutorial.beat.stage.opponentLabel": "Dea luajti: 7♠ 7♥",
  "tutorial.beat.stage.successNarrative": "9-at mundin 7-at. Përgatitja të lejon ta kontrollosh lëvizjen para se të dalë në tavolinë.",
  ...
  "friends.pendingLoadErrorTitle": "Nuk u arrit të ngarkohen kërkesat në pritje.",
  "friends.pendingLoadRetryA11yLabel": "Provo përsëri të ngarkosh kërkesat në pritje",
  "friends.actionFailed": "Veprimi nuk u krye. Provo përsëri.",
  ...
  "profile.verifyEmailTitle": "Verifiko email-in tënd",
  "profile.verifyEmailBody": "Të dërguam një kod te {{email}}. Verifikoje për të përfunduar rikuperimin e fjalëkalimit.",
  "profile.verifyEmailEnterCode": "Shkruaj kodin",
  "profile.verifyEmailResend": "Dërgoje sërish",
  "profile.verifyEmailResendSaving": "Duke dërguar…",
  "profile.verifyEmailResendSuccess": "Kodi u dërgua sërish — kontrollo email-in.",
  "profile.verifyEmailResendFailed": "Kodi nuk u dërgua dot sërish. Provo sërish.",
