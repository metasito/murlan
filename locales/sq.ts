...
export const sq: Record<keyof typeof it, string> = {
  ...
  "gameOverOverlay.winnerSubtitle": "FITUES · Online",
  ...
  "gameOverOverlay.rematch": "Rivansh",
  "gameOverOverlay.voteRematchA11yLabel": "Voto për rivansh",
  "gameOverOverlay.rematchVotes": "{{count}}/{{total}} duan të luajnë",
  ...
  "lobby.roundsLabel": "RAUNDE",
  "lobby.roundSingle": "lojë",
  "lobby.roundMultiple": "raunde",
  ...
  "result.roundOfTotal": "Manche {{current}} nga {{total}}",
  "result.gameOverTitle": "Ndeshja Mbaroi",
  "result.tournamentChampion": "Kampion i Turneut",
  "result.wonRound": "Fitoi Manchen {{n}}",
  "result.statPlayers": "Lojtarë",
  "result.statRounds": "Manche",
  "result.statMode": "Modaliteti",
  "result.legend": "+{{a}} / +{{b}} ... +0 për 1° → i fundit",
  "result.home": "Kreu",
  "result.nextRound": "Manchja Tjetër",
